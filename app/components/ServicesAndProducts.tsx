...
export default function ServicesAndProducts() {
    ...
    return (
        <section className="py-16 md:py-24 bg-gradient-to-b from-[#050505] via-black to-[#050505] relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 relative z-10">
                ...
                >
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4">
                        What We <span className="text-[#D4AF37] drop-shadow-[0_0_15px_rgba(212,175,55,0.3)]">Offer</span>
                    </h2>
                    ...
                    <div className="flex justify-center gap-4 sm:gap-6">
                        <button
                            ...
                            className={`relative px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-bold rounded-xl transition-all duration-300 ${activeTab === "services"
                                ? "text-white bg-white/10 border border-[#D4AF37]/50"
                        ...
                        >
                            ...
                            {activeTab === "services" && (
                                <motion.div
                                    layoutId="activeTab"
                                    className="absolute inset-0 rounded-xl bg-[#D4AF37]/10 border border-[#D4AF37]/50 shadow-[0_0_20px_rgba(212,175,55,0.15)]"
                        ...
                        >
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                                {services.map((service, index) => (
                                    ...
                                    >
                                        {/* Card */}
                                        <div className="bg-white/[0.02] border border-white/10 rounded-2xl overflow-hidden aspect-square transition-all duration-500 hover:border-[#D4AF37] hover:shadow-[0_0_30px_rgba(212,175,55,0.15)] backdrop-blur-sm relative cursor-pointer group-hover:-translate-y-2">
                                            {/* Background Image */}
                                            <div
                                            ...
                                            {/* Dark overlay */}
                                            <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/50 to-black/70 transition-opacity duration-500 group-hover:from-black/30 group-hover:via-black/40 group-hover:to-black/60" />
                                            ...
                                            <div className="relative z-10 h-full flex flex-col items-start justify-end text-left p-4 sm:p-6">
                                                {/* Title */}
                                                <h3 className="text-sm sm:text-base font-bold text-white mb-1 transition-all duration-300 group-hover:text-[#D4AF37] drop-shadow-lg">
                                                    {service.title}
                                                </h3>
                                ...
                                {products.map((product, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="relative aspect-square overflow-hidden">
                                            ...
                                            {/* Dark overlay - matching service cards */}
                                            <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/50 to-black/70 transition-opacity duration-500 group-hover:from-black/20 group-hover:via-black/40 group-hover:to-black/60" />
                                        ...
                                        <div className="absolute bottom-0 left-0 right-0 p-2 sm:p-3 md:p-4 z-10">
                                            <h3 className="text-white font-bold text-sm sm:text-base md:text-lg group-hover:text-[#D4AF37] transition-colors duration-300 leading-tight drop-shadow-lg">
                                                {product.title}
                                            </h3>
                                        </div>
                ...
                >
                    <button className="group flex items-center gap-2 sm:gap-3 bg-gradient-to-r from-[#C9A961] to-[#D4AF37] text-black px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-bold text-base sm:text-lg transition-all duration-300 hover:shadow-[0_0_30px_rgba(212,175,55,0.5)] hover:-translate-y-1 touch-manipulation w-full sm:w-auto">
                    ...
                    <button className="group flex items-center gap-2 sm:gap-3 bg-white/5 border border-white/10 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-bold text-base sm:text-lg transition-all duration-300 hover:bg-white/10 hover:-translate-y-1 touch-manipulation w-full sm:w-auto">
