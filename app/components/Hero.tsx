...
export default function Hero() {
    return (
      ...
      `}</style>
            ...
            {/* === CONTENT === */}
            <div className="relative z-10 mx-auto max-w-7xl w-full px-5 sm:px-6 lg:px-8 pt-[9rem] pb-6 sm:pt-[10rem] sm:pb-12 md:pt-[11rem] md:pb-14 lg:pt-[12rem] lg:pb-20 flex flex-col justify-end h-full lg:justify-center lg:h-auto">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 lg:gap-12">

                    {/* --- LEFT COLUMN --- */}
                    <div className="flex-1 max-w-2xl space-y-3 sm:space-y-5">

                        {/* Heading */}
                        <h1 className="hero-fade-in hfi-2 font-lexend font-bold tracking-tight leading-[1.15]">
                            <span className="block text-[2.75rem] sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-transparent bg-clip-text bg-gradient-to-r from-[#C9A961] via-[#D4AF37] to-[#E8C84A] pb-0.5 sm:pb-2">
                                Premium Printing.
                            </span>
                            <span className="block text-[2.75rem] sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-white mt-0.5 sm:mt-2">
                                Exceptional Design.
                            </span>
                        </h1>

                        {/* Description */}
                        <p className="hero-fade-in hfi-3 max-w-lg text-sm sm:text-lg md:text-xl text-zinc-300/90 leading-relaxed font-light">
                            Premium digital printing & creative design in Sharjah — precision meets passion.
                        </p>

                        {/* CTA Buttons - side by side on mobile */}
                        <div className="hero-fade-in hfi-4 grid grid-cols-2 sm:flex sm:flex-row gap-2.5 sm:gap-3">
                            <Link
                                href="/contact"
                                className="group inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#C9A961] to-[#D4AF37] px-4 py-3 sm:px-8 sm:py-4 text-[13px] sm:text-base font-bold font-lexend text-black transition-all hover:scale-[1.02] hover:shadow-[0_0_35px_rgba(201,168,76,0.45)] active:scale-[0.98]"
                            >
                                Get a Quote
                            ...
                            <Link
                                href="/services"
                                className="group inline-flex items-center justify-center gap-2 rounded-xl border border-white/15 bg-white/5 px-4 py-3 sm:px-8 sm:py-4 text-[13px] sm:text-base font-bold font-lexend text-white backdrop-blur-sm transition-all hover:bg-white/10 hover:border-[#C9A84C]/30 hover:shadow-[0_0_20px_rgba(255,255,255,0.05)]"
                            >
                                <CheckCircle2 className="w-3.5 h-3.5 sm:w-5 sm:h-5 text-[#C9A84C]" />
                                Our Services
                            </Link>
                        </div>

                        {/* Mobile-only compact stats card */}
                        <div className="hero-fade-in hfi-5 lg:hidden mt-3">
                            <div className="flex items-center justify-between gap-3 rounded-xl border border-white/10 bg-black/30 backdrop-blur-md px-4 py-3">
                                <div className="flex items-center gap-2">
                                    <div className="flex items-center justify-center w-7 h-7 rounded-lg bg-[#C9A84C]/10">
                                        <Clock className="w-3.5 h-3.5 text-[#C9A84C]" />
                                    </div>
                                    <div>
                                        <div className="text-xs font-bold text-white font-lexend">20+</div>
                                        <div className="text-[9px] text-zinc-400 uppercase tracking-wider">Years</div>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <div>
                                        <div className="text-xs font-bold text-white font-lexend">24/7</div>
                                        <div className="text-[9px] text-zinc-400 uppercase tracking-wider">Support</div>
                                    </div>
                                </div>
                                <div className="w-px h-8 bg-white/10" />
                                <div className="flex items-center gap-2">
                                    ...
                                    <div>
                                        <div className="text-xs font-bold text-white font-lexend">100%</div>
                                        <div className="text-[9px] text-zinc-400 uppercase tracking-wider">Quality</div>
                                    </div>
                                </div>
                            </div>
                        </div>
