...
function Mission() {
    return (
        <section id="about" className="relative py-14 sm:py-24 lg:py-32 overflow-hidden bg-white font-rajdhani">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-16 lg:gap-24 items-center">
                    ...
                    >
                        <div className="space-y-4 sm:space-y-6">
                            <div className="inline-block px-3 py-1 sm:px-4 sm:py-1.5 rounded-full bg-[#D4AF37]/10 border border-[#D4AF37]/20">
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative p-5 sm:p-8 lg:p-10 rounded-2xl sm:rounded-[2rem] bg-white border border-gray-100 shadow-[0_20px_50px_rgba(0,0,0,0.05)] backdrop-blur-sm transition-all duration-500 group-hover:shadow-[0_40px_80px_rgba(212,175,55,0.1)] group-hover:border-[#D4AF37]/20">
                        ...
                        {/* Signature Quote */}
                        <div className="pl-4 sm:pl-6 border-l-4 border-[#D4AF37]/30 italic text-gray-400 font-medium text-sm sm:text-base">
                            "Committed to quality, dedicated to your success."
                        </div>
                    </motion.div>

                    {/* Right: Image Composition */}
                    <div className="lg:col-span-7 relative pt-8 sm:pt-12 lg:pt-0">
                        {/* Main Image - Large */}
                        <motion.div
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <div className="text-2xl font-semibold text-gray-900 leading-none">2,000+</div>
                                    <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mt-1">Happy Clients</div>
                                </div>
                            </div>
                        </motion.div>
